                    ...
                    <>
                        ...
                        <View style={styles.section}>
                            ...
                            {contacts.map((contact) =>
                                (() => {
                                    const isContactOnline = onlineUserIds.has(contact.user.id);
                                    const lastSeenAt =
                                        lastSeenMap[contact.user.id] ?? contact.user.lastSeenAt;
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <View style={styles.userInfo}>
                                                ...
                                                <Text style={styles.userHandle}>
                                                    {getPresenceString(isContactOnline, lastSeenAt)}
                                                </Text>
                                            </View>
                                        </TouchableOpacity>
                                    );
