...
function initStorage() {
    return __awaiter(this, void 0, void 0, function () {
        var _i, _a, bucket, error;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _i = 0, _a = Object.values(exports.BUCKETS);
                    _b.label = 1;
                case 1:
                    if (!(_i < _a.length)) return [3 /*break*/, 4];
                    bucket = _a[_i];
                    return [4 /*yield*/, exports.supabase.storage.createBucket(bucket, {
                            public: true,
                ...
                case 2:
                    ...
                    if (error && !error.message.includes('already exists')) {
                        console.error("Failed to create bucket \"".concat(bucket, "\":"), error.message);
                    }
                    _b.label = 3;
                case 3:
                    _i++;
